...
def extract_all_audio_data(file_path):
    try:
        ...
        delta = librosa.feature.delta(mfcc_matrix)
        ...
        features_vector = np.hstack([
            np.mean(mfcc_matrix.T, axis=0),
            np.std(mfcc_matrix.T, axis=0),
        ...
        <div class="card">
            ...
            <div class="feature-item" style="padding: 0.75rem 0;">
                <div>
                    ...
                    <div class="feature-desc">40-coefficient MFCC + Delta + Delta-Delta
with mean and standard deviation statistics
(240 total features).</div>
                </div>
            </div>
            <div class="feature-item" style="padding: 0.75rem 0;">
                <div>
